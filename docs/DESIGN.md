...
> Design notes for **bg-remove-saas-typescript-a** — a runnable typescript example that Typed SaaS listing workflow for removing product-photo backgrounds with Infrai.
...
- **Feature code** — the actual task: catalog image cleanup.
